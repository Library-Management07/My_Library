...
class S7cc extends StatefulWidget {
  @override
  _S7ccState createState() => _S7ccState();
}

class _S7ccState extends State<S7cc> {
  nested() {
...
final List<Books> _Books = <Books>[
  Books(
    bookname: "Cloud computing concepts",
    avail: '0',
  ),
  Books(
    bookname: "Distributed and cloud computing",
    avail: '0',
  ),
];
