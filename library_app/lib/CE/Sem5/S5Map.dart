...
class S5Map extends StatefulWidget {
  @override
  _S5MapState createState() => _S5MapState();
}

class _S5MapState extends State<S5Map> {
  nested(){
...
final List<Books> _Books = <Books>[
  Books(
    bookname: "MicroProcessors and Interfacing programming and hardware",
    avail: '1',
  ),
  Books(
    bookname: "Advance MicroProcessor",
    avail: '0',
  ),
