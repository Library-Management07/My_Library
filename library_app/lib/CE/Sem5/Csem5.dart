                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => S5Map()));
                  },
                  child: Container(
                    child: Center(
                        child: Text(
            ...
            Center(
              child: SizedBox(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => S5da()));
                  },
                  child: Container(
                    child: Center(
                        child: Text(
            ...
            Center(
              child: SizedBox(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => S5Se()));
                  },
                  child: Container(
                    child: Center(
                        child: Text(
            ...
            Center(
              child: SizedBox(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => S5Cn()));
                  },
                  child: Container(
                    child: Center(
                        child: Text(
            ...
            Center(
              child: SizedBox(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => S5Ajp()));
                  },
                  child: Container(
                    child: Center(
                        child: Text(
            ...
            Center(
              child: SizedBox(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => S5Apnet()));
                  },
                  child: Container(
                    child: Center(
                        child: Text(
                      "Advance Programming using .net",
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                      ),
                    )),
            ...
            Center(
              child: SizedBox(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => S5Mad()));
                  },
                  child: Container(
                    child: Center(
                        child: Text(
            ...
            Center(
              child: SizedBox(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => S5Hs()));
                  },
                  child: Container(
                    child: Center(
                        child: Text(
