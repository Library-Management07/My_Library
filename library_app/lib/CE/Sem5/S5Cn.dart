...
class S5Cn extends StatefulWidget {
  @override
  _S5CnState createState() => _S5CnState();
}

class _S5CnState extends State<S5Cn> {
  nested(){
...
final List<Books> _Books = <Books>[
  ...
  Books(
    bookname: "An introduction to Communication and networking",
    avail: '0',
  ),
];
