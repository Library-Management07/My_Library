...
class S6Hs extends StatefulWidget {
  @override
  _S6HsState createState() => _S6HsState();
}

class _S6HsState extends State<S6Hs> {
  nested(){
...
final List<Books> _Books = <Books>[
  Books(
    bookname: "Personality development and soft skills",
    avail: '0',
  ),
  Books(
    bookname: "Soft skills",
    avail: '0',
  ),
];
