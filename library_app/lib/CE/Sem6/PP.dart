...
class S6PP extends StatefulWidget {
  @override
  _S6PPState createState() => _S6PPState();
}

class _S6PPState extends State<S6PP> {
  nested(){
...
final List<Books> _Books = <Books>[
  Books(
    bookname: "Beginning python from novice to professional",
    avail: '0',
  ),
  Books(
